...
**Description:** Weekly weigh-in entry (date, weight in kg, optional note). Line chart of the trend over time, with a target line at 76kg. Progress shown both in kilograms remaining and as a percentage of the 84.2 → 76kg journey. A trailing average smooths daily noise if weigh-ins become more frequent than weekly.
...
- [ ] Target line at 76kg and starting weight are both visible on the chart
- [ ] Progress displayed as kg lost, kg remaining, and % of the way to target
- [ ] Current rate (kg/week over the trailing 4 weeks) shown against the 0.5kg/week goal pace
...
| Weight trend on track | 0.5kg/week trailing 4-week average | Rate calculation in the app |
