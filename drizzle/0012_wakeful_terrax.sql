...
ALTER TABLE "walk_routes" ADD CONSTRAINT "walk_routes_log_fk" FOREIGN KEY ("workout_log_id","user_id") REFERENCES "public"."workout_logs"("id","user_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
